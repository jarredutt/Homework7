//*****************************************************************
//      CS2401- Project 6- The Othello Game, Phase 3- game.cc
//      Fall 2017- December 10, 2017
//      Author: Jarred Utt
//      Description: A class given to us by the instructor to
//					 utilize in our construction of the Othello 
//					 game class. Is the parent class of Othello.
//*****************************************************************
// File: game.cxx
...
/*    void game::display_message(const string& message) const
	...
	// Make the best move.
	make_move(best_move);
	cout << "Computer makes move " << best_move << endl;
	pass_count = 0;
    }
	...
	cout << "Player's turn!(Black)" << endl;


	cout << "Enter a space (Ex: A1) Enter 00 to pass: ";
	cin >> move;
