//*****************************************************************
//      CS2401- Project 6- The Othello Game, Phase 3- game.h
//      Fall 2017- December 10, 2017
//      Author: Jarred Utt
//      Description: A header file for class othello, to play a game
//					 of Othello.
//*****************************************************************
...
namespace main_savitch_14
{
	...
	game( ) { move_number = 0; pass_count = 0;}
	game(game* copy) {move_number = copy -> moves_completed();}
	virtual ~game( ) {move_number = 0; }
	...
	virtual int pass_counting() const {return pass_count;}
	// *******************************************************************
